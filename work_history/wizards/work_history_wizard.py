...
class WorkHistoryWizard(models.TransientModel):
    ...
    def insert_works(self):
        ...
        storable_product_id = self.storable_product_id and self.storable_product_id.id or None
        ...
        action = self.env['ir.actions.act_window'].for_xml_id('work_history', 'work_history_action')
        return action
